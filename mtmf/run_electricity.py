"""
Running various methods on mixed-frequency real data - PyTorch Version
...
parser.add_argument('--config', default='configs/electricity/seq2seq.yaml')
...
def main():
    ...
    # PyTorch trainer with MSE loss
    trainer = nnTrainer(args=args, criterion=nn.MSELoss(), seed=411)
